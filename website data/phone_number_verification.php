							...
							<input type="hidden" value="<?=$action; ?>" id="action" name="action12" >
								...
								<span class="newrow">
		                           <b>
									...
									<abbr style="float: left; padding: 0 15px;"><?=$langage_lbl['LBL_SIGNUP_Agree_to']; ?>  <a href="terms_condition.php" target="_blank" style="margin: 0;float: none; "><?=$langage_lbl['LBL_SIGN_UP_TERMS_AND_CONDITION']; ?>  </a> and <a href="privacy-policy" target="_blank" style="margin: 0;float: none; "><?=$langage_lbl['LBL_PRIVACY_POLICY_TEXT']; ?>  </a>
