										...
										<div class="action-driv"> 
											<div class="col-md-4">   
												<span class="driver-phone-number">
													...
													<input name="vPhone" type="text" value="<?= $vPhone; ?>" class="driver-action-page-input input-phNumber2" placeholder="<?=$langage_lbl['LBL_Phone_Number']; ?>" " title="Please enter proper mobile number." required />
