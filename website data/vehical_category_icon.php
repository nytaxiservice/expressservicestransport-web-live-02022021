...
$catquery = "SELECT iVehicleCategoryId,vHomepageLogo,vCategory_" . $_SESSION['sess_lang'] . " as vehicalcategory FROM `vehicle_category` WHERE iParentId = 0 and eStatus = 'Active'";
