                ...
                <div class="content map-main-page-inner-tab" id="content_1">
                    <div class="form-group service-type">
                        ...
                        if ($etype == 'Ride') {
                            ...
                            ?> onChange="show_type(this.value), showVehicleCountryVise($('#vCountry option:selected').val(), '<?= $iVehicleTypeId; ?>', this.value);" checked="checked">
                            ...
                            ?> onChange="show_type(this.value), showVehicleCountryVise($('#vCountry option:selected').val(), '<?= $iVehicleTypeId; ?>', this.value);">
                    ...
                    <div class="map-live-hs-mid">
                        ...
                        <div class="pickup-location pickup-location1" style="margin-bottom: 10px;">
                            ...
                            <span class="form-group"><div><input name="vCouponCode" id="promocode" type="text" placeholder="<?= $langage_lbl['LBL_COUPON_CODE_WEB']; ?>" value="<?= $vCouponCode ?>" class="clearable clearpromotxt"></div></span>
...
<?php } ?>
    ...
    <div class="form-content" style="display:none;">
        ...
        <p style="text-align: center;font-weight: bold;">
            <span><?= $langage_lbl['LBL_Total_Fare']; ?> <?= $data1['currencySymbol']; ?><b id="totalcost">0</b></span>+
