...
if(!empty($msg)){
	...
	echo '<div class="arriving-bottom-part-top"><h5>Driver ' . $driver["vName"] . ' ' . $driver["vLastName"] . ' is Arriving With Car Number '.$driver["vLicencePlate"].'. If You Have any Query Then Call on (<b> +'.$driver["vCode"].' '.$driver["vPhone"].'</b>).</h5></div>';
