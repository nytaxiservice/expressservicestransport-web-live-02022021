                                ...
                                <tr>
                                    ...
                                    <? if ($APP_TYPE == 'Ride-Delivery' || $APP_TYPE == 'Ride-Delivery-UberX') { ?>
                                        ...
                                        echo "selected";
                                                ...
                                                <option value="UberX" <?php if ($eType == 'UberX') {
                                                echo "selected";
                                            } ?> >Service</option>
    <? if (DELIVERALL == 'Yes') { ?>
                                                    <option value="DeliverAll" <?php if ($eType == 'DeliverAll') {
            echo "selected";
        } ?> >DeliverAll</option>
                                                <? } ?>
                                            </select>
                                        </td>
                                            <? } else if (DELIVERALL == 'Yes' && ($APP_TYPE != 'Ride-Delivery-UberX' && $APP_TYPE != 'Ride-Delivery')) { ?>
                                        <td width="12%" class="eType_options" id="eType_options" >
                                            <select name="eType" id="eType_value" class="form-control">
                                                <option value="" >Select Service Type</option>
                                                <? if ($APP_TYPE == 'Ride') { ?>
