...
$sql = "SELECT iPageId,vPageName,vTitle,eStatus,vPageTitle_" . $default_lang . ",tPageDesc_" . $default_lang . " FROM " . $tbl_name . " where ipageId NOT IN('5','20','21') $ssql $ord LIMIT $start, $per_page "; //added by SP for pages orderby,active/inactive functionality start
...
<?php include('valid_msg.php'); ?>
    ...
    echo "selected";
                                            ...
                                            <option value="<?= 'vPageTitle_' . $default_lang ?>" <?php if ($option == "vPageTitle_.$default_lang") {
    echo "selected";
} ?> >Page Title</option>
...
<?php } ?>
    ...
    echo $order;
} else { ?>0<?php } ?>)">Page Title <?php if ($sortby == 2) {
                                                    if ($order == 0) { ?><i class="fa fa-sort-amount-asc" aria-hidden="true"></i> <?php } else { ?><i class="fa fa-sort-amount-desc" aria-hidden="true"></i><?php }
                                        } else { ?><i class="fa fa-sort" aria-hidden="true"></i> <?php } ?></a></th>

                                                    <th align="center" style="text-align:center;">Status</th>

                                                <th width="5%" align="center" style="text-align:center;"><!--<a href="javascript:void(0);" onClick="Redirect(4,<?php if ($sortby == '4') {
                                                    echo $order;
