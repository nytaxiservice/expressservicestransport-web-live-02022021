...
<div class="col-lg-6">
  <input type="text" id="dp5" name="dBirthDate" placeholder="From Date"  readonly class="form-control" value="<?= $dBirthDate ?>" style="cursor:default; background-color: #fff" required />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text"  class="form-control" name="vBankName"  id="vBankName" value="<?= $vBankName ?>" placeholder="Bank Name" >
                                    </div>
                                </div>
                                ...
                                <?php if (($APP_TYPE == 'UberX' || $APP_TYPE == 'Ride-Delivery-UberX') && ONLYDELIVERALL != 'Yes') { ?>
...
<?php if (ONLYDELIVERALL == 'No') { ?> iCompanyId: { 	required: true },<?php } ?>
                                            vCurrencyDriver: {
                                            required: true
                                            }
                                            }
