...
if (!empty($keyword)) {
    if (!empty($option)) {
        if ($option == 'eStatus') {
            ...
            //if($eStatus != ''){
            //$sql = "SELECT AG.iGroupId FROM admin_groups AG INNER JOIN administrators AD ON AG. = AD. WHERE AG.vGroup LIKE '%".$keyword."%' AND AG.eStatus != 'Deleted' AND AD.eStatus = '".$eStatus."'";
            //}
            ...
            //$iGroupIdArrTxt = implode(',',$iGroupIdArr);
            //$query->whereIn('iGroupId',[$iGroupIdArrTxt]);
        } else {
                                            ...
                                            <tbody>
                                                ...
                                                if (!empty($data_drv)) {
                                                    foreach ($data_drv as $key => $row) {
                                                        ...
                                                        ?>
                                                        <tr class="gradeA">
        <? if (($_SESSION['sess_iAdminUserId'] == $row['iAdminId']) || $row['eDefault'] == 'Yes') { ?>
...
<?php include('pagination_n.php'); ?>
                    ...
                    <div class="admin-notes">
                        ...
                        <ul>
                            <li>
                                Administrator module will list all admin users on this page.
                            </li>
                            <li>
                                Administrator can Activate , Deactivate , Delete any other admin users.
                            </li>
                            <li>
