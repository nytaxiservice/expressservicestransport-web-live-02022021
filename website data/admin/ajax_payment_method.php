...
if (isset($_REQUEST['paylog']) && $_REQUEST['paylog'] == 1) {
    ...
    if ($envmode > 0) {
        $obj->sql_query("UPDATE `register_driver` SET `vCreditCard` = '', `vStripeToken` = '', `vStripeCusId` = '', `vBrainTreeToken` = '', `vBrainTreeCustEmail` = '',`vBrainTreeCustId` = '', `vPaymayaCustId`= '', `vPaymayaToken` = '', `vOmiseCustId` = '', `vOmiseToken` = '', `vAdyenToken` = '',`vXenditToken` = '', `vXenditAuthId` = '',vFlutterWaveToken=''");
        $obj->sql_query("UPDATE `register_user` SET `vCreditCard` = '', `vStripeToken` = '', `vStripeCusId` = '', `vBrainTreeToken` = '', `vBrainTreeCustEmail` = '',`vBrainTreeCustId` = '', `vPaymayaCustId`= '', `vPaymayaToken` = '', `vOmiseCustId` = '', `vOmiseToken` = '', `vAdyenToken` = '',`vXenditToken` = '', `vXenditAuthId` = '',vFlutterWaveToken=''");
        echo"updated";
    } else {
