...
$menu = [
    ...
    [
        ...
        "icon" => "fa fa-bullhorn",
        "active" => "Driver",
        "visible" => $userObj->hasPermission('view-blocked-driver') && $PACKAGE_TYPE == 'SHARK',
        'children' => [
            [
                'title' => 'Alert For Driver',
                'url' => "blocked_driver.php",
                "icon" => "fa fa-user",
                "active" => "blockeddriver",
                "visible" => $userObj->hasPermission('view-blocked-driver'),
            ], [
                'title' => 'Alert For Rider',
    ...
    [
        ...
        'children' => [
            [
                ...
                'children' => [
                    ...
                    [
                        ...
                        "icon" => "fa fa-dot-circle-o",
                        "active" => "city",
                        "visible" => $userObj->hasPermission('view-city'),
                    ],
                ],
            ], [
                'title' => "Pages",
            ...
            [
                ...
                "icon" => "fa fa-globe",
                "active" => "Package",
                "visible" => $userObj->hasPermission('view-package-type') && ($APP_TYPE == 'Ride-Delivery-UberX' || $APP_TYPE == 'Ride-Delivery' || $APP_TYPE == 'Delivery'),
            ],
            [
                ...
                "visible" => $userObj->hasPermission('view-popular-stores'),
            ], [
