...
<table border="1" class="table table-bordered" width="100%" align="center" cellspacing="5" cellpadding="10px">
    <tbody>
        ...
        <tr>
            <td class="text_design"><?= $langage_lbl_admin['LBL_DRIVER_TXT_ADMIN'] ?> Company</td>
