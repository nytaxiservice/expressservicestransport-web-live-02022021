...
<html lang="en">
    ...
    <head>
        <meta charset="UTF-8" />
        <title><?= $SITE_NAME ?> | Service Request for  <?=$name?> <?=$vLastName?></title>
            ...
            <div id="content">
                <div class="inner">
                    <div id="add-hide-show-div">
                        <div class="row">
                            <div class="col-lg-12">
                                <h2>Service Request for  <?=$name?> <?=$vLastName?> </h2>
                                                ...
                                                <tbody>
                                                        <?php
                                                            foreach ($Requests as $key => $Request) {
                                                                ...
                                                                LEFT JOIN vehicle_category AS vc ON vc.iVehicleCategoryId = vt.iVehicleCategoryId 
                                                                LEFT JOIN vehicle_category AS vc1 ON vc1.iVehicleCategoryId = vc.iParentId 
