                        ...
                        <div class="form-group">
                            ...
                            <form id="_notification_form" name="_notification_form" method="post" action="javascript:void(0);" >
                                ...
                                <div class="row set-dd-css" id="driverRw">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" name="iDriverId" id="iDriverId" class="form-control magicsearch" style="width:629px !important;" placeholder="Select <?= $langage_lbl_admin['LBL_DRIVERS_NAME_ADMIN'] ?>" value=""/>
                                    </div>
                                </div>
                                <div class="row set-dd-css" id="riderRw" style="display:none;">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" name="iRiderId" id="iRiderId" class="form-control magicsearch" style="width:629px !important;" placeholder="Select <?= $langage_lbl_admin['LBL_RIDERS_ADMIN'] ?>" value=""/>
                                    </div>
                                </div>
                                <?php if (!empty($db_login_drv_list)) { ?>
                                    <div class="row set-dd-css" id="logindriverRw" style="display:none;">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" name="iLoginDriverId" id="iLoginDriverId" class="form-control magicsearch" style="width:629px !important;" placeholder="Select <?= $langage_lbl_admin['LBL_DRIVERS_NAME_ADMIN'] ?>" value=""/>
                                        </div>
                                    </div>
                                <?php } ?>
                                <?php if (!empty($db_login_rdr_list)) { ?>
                                    <div class="row set-dd-css" id="loginriderRw" style="display:none;">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" name="iLoginRiderId" id="iLoginRiderId" class="form-control magicsearch" style="width:629px !important;" placeholder="Select <?= $langage_lbl_admin['LBL_RIDERS_ADMIN'] ?>" value=""/>
                                        </div>
                                    </div>
                                <?php } ?>
                                <?php if (!empty($db_inactive_drv_list)) { ?>
                                    <div class="row set-dd-css" id="inactive_driverRw" style="display:none;">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" name="iInactiveDriverId" id="iInactiveDriverId" class="form-control magicsearch" style="width:629px !important;" placeholder="Select <?= $langage_lbl_admin['LBL_DRIVERS_NAME_ADMIN'] ?>" value=""/>
                                        </div>
                                    </div>
                                <?php } ?>
                                <?php if (!empty($db_inactive_rdr_list)) { ?>
                                    <div class="row set-dd-css" id="inactive_riderRw" style="display:none;">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" name="iInactiveRiderId" id="iInactiveRiderId" class="form-control magicsearch" style="width:629px !important;" placeholder="Select <?= $langage_lbl_admin['LBL_RIDERS_ADMIN'] ?>" value=""/>
                                        </div>
                                    </div>
                                <?php } ?>
                                <?php if (DELIVERALL == 'Yes') { ?>
                                    ...
                                    <div class="row set-dd-css" id="storeRw" style="display:none;">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" name="iCompanyId" id="iCompanyId" class="form-control magicsearch" style="width:629px !important;" placeholder="Select <?= $langage_lbl_admin['LBL_RESTAURANT_TXT_ADMIN'] ?>" value=""/>
                                        </div>
                                    </div>
                                    <div class="row set-dd-css" id="loginstoreRw" style="display:none;">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" name="iLoginCompanyId" id="iLoginCompanyId" class="form-control magicsearch" style="width:629px !important;" placeholder="Select <?= $langage_lbl_admin['LBL_RESTAURANT_TXT_ADMIN'] ?>" value=""/>
                                        </div>
                                    </div>
                                    <div class="row set-dd-css" id="inactive_storeRw" style="display:none;">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" name="iInactiveCompanyId" id="iInactiveCompanyId" class="form-control magicsearch" style="width:629px !important;" placeholder="Select <?= $langage_lbl_admin['LBL_RESTAURANT_TXT_ADMIN'] ?>" value=""/>
                                        </div>
                                    </div>
                                <?php } ?>
