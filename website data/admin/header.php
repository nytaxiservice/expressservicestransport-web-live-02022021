...
if ($host_system == 'cubetaxishark' || $host_system == 'cubetaxi5plus') {
    $logo = "admin-logo-taxi.png";
    $logosmall = "logo-small-taxi.png";
} else if ($host_system == 'cubedelivery') {
    $logo = "admin-logo_delivery.png";
    $logosmall = "logo-small_delivery.png";
} else {
    $logo = "admin-logo.png";
...
<div class="wrapper1">
    ...
    <header class="main_header">
        <div class="header clearfix">
            <a href="<?= $dashboardLink; ?>" title="" class="logo"> <span class="logo-mini"> <img src="images/<?php echo $logosmall; ?>" alt="" /> </span> <span class="logo-lg minus"> <img src="images/<?php echo $logo; ?>" alt="" /> </span> </a>
