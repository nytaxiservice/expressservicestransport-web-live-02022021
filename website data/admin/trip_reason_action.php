                        ...
                        <div class="form-group">
                            ...
                            <form id="_vehicleType_form" name="_vehicleType_form" method="post" action="" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <select class="form-control" name = 'iUserProfileMasterId' id="iUserProfileMasterId" required="" onchange="changeCode_distance(this.value);">
