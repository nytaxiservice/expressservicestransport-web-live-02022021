                ...
                <div class="inner" style="min-height: 700px;">
                    ...
                    <form name="add_booking_form" id="add_booking_form" method="post" action="action_booking.php" >
                            ...
                            <div class="map-main-page-inner">
                                <div class="map-main-page-inner-tab">
                                    ...
                                    <div class="col-lg-12 map-live-hs-mid">
                                        ...
                                        <?php } ?>
                                        <span id="showdriverSet001" style="display:none;"><p class="margin-right5">Assigned <?= $langage_lbl_admin['LBL_DRIVER_TXT']; ?>: </p><p id="driverSet001"></p></span>
                                    </div>
                        ...
                        <div class="admin-notes">
                            ...
                            <ul>
                                <li>
                                    Administrator can Add / Edit <?= $langage_lbl['LBL_RIDER_RIDE_MAIN_SCREEN']; ?> later booking on this page.
                                </li>
                                <li>
        ...
        <div class="modal-dialog modal-large">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel"><?= "aaaa" . $langage_lbl['LBL_DIS_HOW_IT_WORKS']; ?></h4>
                </div>
                <div class="modal-footer">
