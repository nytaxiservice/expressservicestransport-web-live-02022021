                    ...
                    <div id="add-hide-show-div">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <span style="float: right;"><strong>Current Time :</strong> <?=date('d-m-y (h:i A)')?></span>
                            </div>
                        </div>
                        <hr />
                    </div>
                                                    ...
                                                    for ($i = 0; $i < count($data_drv); $i++) {
                                                        ...
                                                        <tr class="gradeA">
                                                            ...
                                                            <?php if ($data_drv[$i]['eAutoAssign'] == "Yes" && $data_drv[$i]['iRentalPackageId'] > 0) { ?>
                                                                ...
                                                                <td width="10%"><?= $langage_lbl_admin['LBL_DRIVER_TXT_ADMIN']; ?> : Auto Assign </b><br />( Car Type : <?= $data_drv[$i]['vRentalVehicleTypeName']; ?>)<br/>
                                                            ...
                                                            <?php } else if ($data_drv[$i]['eAutoAssign'] == "Yes" && $data_drv[$i]['iDriverId'] == 0 && $data_drv[$i]['eStatus'] != 'Cancel') {
                                                                ...
                                                                <td width="10%"><?= $langage_lbl_admin['LBL_DRIVER_TXT_ADMIN']; ?> : Auto Assign </b><br />( Car Type : <?= $data_drv[$i]['vVehicleType']; ?>)<br/><?php
                                                                ...
                                                                if (!empty($data_stat_check)) {
                                                                    for ($d = 0; $d < count($data_stat_check); $d++) {
                                                                        if ($data_stat_check[$d]['iActive'] == "Canceled") {
                                                                            ...
                                                                            ?>
                                                                            <a target = "_blank" class="btn btn-primary" href="invoice.php?iTripId=<?= base64_encode(base64_encode($data_drv[$i]['iTripId'])) ?>" target="_blank">View</a>
...
//                                  changed by me
                                                                ...
                                                                if ($data_drv[$i]['eStatus'] == "Assign" && $bookingdatecmp > $setcurrentTime) {
                                                                    ...
                                                                    ?>
                                                                    <br /><a href="javascript:void(0);" data-bookId="<?= $data_drv[$i]['iCabBookingId']; ?>" onclick="displayBookingReason(this);" data-cancelBy="<?= $eCancelBy; ?>" data-reason="<?= $cancelReasonTxt; ?>" class="btn btn-info" data-toggle="modal">Cancel Reason</a>
                                                                    <?php
                                                                } else {
                                                                    $sql = "select iActive, eCancelledBy from trips where iTripId=" . $data_drv[$i]['iTripId'];
