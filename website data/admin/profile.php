                    ...
                    <div class="form-group">
                        ...
                        <form name="_admin_form" id="_admin_form" method="post" action="" enctype="multipart/form-data">
    						...
    						<div class="row">
    							...
    							<div class="col-lg-6">
    									<select class="form-control valid" name = 'vCountry' onChange="changeCode(this.value);setState(this.value,'<?=$vState?>');" required>
                            ...
                            <div class="row">
                                 ...
                                 <div class="col-lg-6">
                                    <? if (isset($vVehicleTypeImg) && $vVehicleTypeImg != '') { ?>                                               
