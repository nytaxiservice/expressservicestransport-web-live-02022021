                            ...
                            <form name="_vehicle_form" id="_vehicle_form" method="post" action="">
                                ...
                                <? if (ONLYDELIVERALL == 'No') { ?>	
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <select name = "iDriverId" id="driverNo" class="form-control">
                                ...
                                <? } else { ?>
                                    <input type="hidden" name="iCompanyId" value="<?= $defaultCompany; ?>">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <label><?php echo $langage_lbl_admin['LBL_VEHICLE_DRIVER_TXT_ADMIN']; ?> <span class="red"> *</span></label>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <?php if (($action == 'Edit' && $userObj->hasPermission('edit-provider-taxis')) || ($action == 'Add' && $userObj->hasPermission('create-provider-taxis'))) { ?>
                                            <input type="submit" class="btn btn-default" name="submit" id="submit"  value="<?php if ($action == 'Add') { ?><?= $action; ?> <?php echo $langage_lbl_admin['LBL_TEXI_ADMIN']; ?><?php } else { ?>Update<?php } ?>">
