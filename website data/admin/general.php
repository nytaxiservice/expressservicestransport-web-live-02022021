...
foreach ($data_gen as $key => $value) {
    ...
    $value['tDescription'] = str_replace("Provider", $langage_lbl_admin['LBL_DRIVER_TXT_ADMIN'], $value['tDescription']); //Added By HJ On 21-08-2019 For Solved Issue to fixed Sheet Id : 250 BY HS Mam
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <ul class="nav nav-tabs">
                                            ...
                                            <?php }
                                            ?>
                                            <li><a data-toggle="tab" href="#soundsetting">Notification Sound</a></li>
                                        </ul>
                                            ...
                                            <div id="soundsetting" class="tab-pane">
                                                <form method="POST" action="" name="frm_soundsetting" novalidate>
                                                    ...
                                                    foreach ($userSoundDataArr as $for => $data) {
                                                        ...
                                                        $helpTxt = "";
                                                        if ($for == "Dial") {
                                                            $headName = "New Trip/Job Request (i.e 30 second Dial) Screen";
                                                            $helpTxt = "Selected notification sound will be played when service provider/driver receives new trip/job request. If you select 'Phone's default Notification Sound' option then it will play your phone's default tone.";
                                                        } else if ($for == "Voip") {
                                                            ...
                                                            $helpTxt = "Selected notification sound will be played when service provider/driver receives rest of notifications apart from new trip/job notification. If you select 'Phone's default Notification Sound' option then it will play your phone's default tone. ";
                                                        } else if ($for == "Store") {
                                                            ...
                                                            $helpTxt = "Selected notification sound will be played when user app receives notifications for events like job/trip start, job/trip end and all other kind of push notifications. If you select 'Phone's default Notification Sound' option then it will play your phone's default tone.";
                                                        }
                                                        ?>
                                                        <div class="row">
                                                            <div class="col-lg-8">
                                                                <div class="form-group">
                                                                    <h3>Notification Sound For <?= $headName; ?> <i class="icon-question-sign" data-placement="top" data-toggle="tooltip" data-original-title='<?= $helpTxt; ?>'></i></h3>
                                                                </div>
                                                                <?php
