...
<div id="top-part" class="<?= $col_class; ?>">
            ...
            <?php if (isset($_REQUEST['edit_lbl'])) { ?>
                ...
                <div class="top-link"> 
                    <span>
                        ...
                        <a href="<?= $cjSignIn; ?>"  class="<?php echo strstr($_SERVER['SCRIPT_NAME'], '/'.$cjSignIn) || strstr($_SERVER['SCRIPT_NAME'], '/login-new') ? 'active' : '' ?>"><?= $langage_lbl['LBL_HEADER_TOPBAR_SIGN_IN_TXT']; ?></a>
                    </span>
                </div>
    ...
    <a class="active" href="<?= $cjSignupCompany; ?>"><? //=$langage_lbl['LBL_HEADER_TOPBAR_BECOME_A_DRIVER'];   ?></a>
                    </span>
            </div-->
            <?php
        }
