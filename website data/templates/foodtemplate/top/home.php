    ...
    <div class="download-app-today">
        <div class="download-app-today-inner">
            <div class="download-app-today-text">
                <h3>
                    <?
                    if (!empty($data[0]['ThirdRightTitle'])) {
                        echo $data[0]['ThirdRightTitle'];
                    } else {
                        echo 'restaurant  in your pocket';
                    }
                    ?>
                </h3>
                <?
...
<?php } ?>
    ...
    <div class="about-banner" style="background-image:url('assets/img/page/home/<?php echo $data[0]['AboutUsBgImage']; ?>')">
        <div class="about-banner-inner">
            <h4>
                <?
                if (!empty($data[0]['AboutUsTitle'])) {
                    echo $data[0]['AboutUsTitle'];
                } else {
                    echo 'About Us';
                }
                ?> 
            ...
            <strong>
                <?
                if (!empty($data[0]['AboutUsSecondTitle'])) {
                    echo $data[0]['AboutUsSecondTitle'];
                } else {
                    echo 'The Entire Eatery Range At Your Fingertips';
                }
                ?>
            </strong>
            <?
        ...
        ?>
                            <li>
                                ...
                                <p><?php echo $RestaurantData[$i]['cusines'] ?> 
                                    <b>
                            <?php if ($RestaurantData[$i]['vAvgRating'] > 0) { ?>
