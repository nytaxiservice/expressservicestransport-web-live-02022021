...
<!--Added By HJ On 10-06-2019 For Manual Store Order Section On Home Page Start  -->
<div class="storeorder-section" style="background-image:url(<?= $tconfig["tsite_upload_apptype_page_images"] . $template . '/' . $data[0]['manual_order_bg_img']; ?>);">
    <div class="storeorder-section-inner">
        <h3><strong><?= $data[0]['manual_order_first_label']; ?></strong><?= $data[0]['manual_order_second_label']; ?></h3>
        <a href="<?= $siteUrl; ?>order-items?order=guest" target="_blank"><?= $data[0]['manual_order_button_label']; ?></a>
        <p><?= $data[0]['manual_order_desc']; ?></p>
    </div>
</div>
<!--Added By HJ On 10-06-2019 For Manual Store Order Section On Home Page End  -->
<?php } ?>
