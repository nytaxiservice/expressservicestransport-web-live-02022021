        ...
        <?php if ($user == "") { ?>
            <div class="header-right">
                <ul>
                    ...
                    <li><a href="<?= $cjSignIn; ?>"  class="unic-btn <?php echo strstr($_SERVER['SCRIPT_NAME'], '/' . $cjSignIn) || strstr($_SERVER['SCRIPT_NAME'], '/login-new') ? 'active' : '' ?>"><?= $langage_lbl['LBL_HEADER_TOPBAR_SIGN_IN_TXT']; ?></a></li>
                </ul>
            </div>
        <?php } ?>
    </div>
