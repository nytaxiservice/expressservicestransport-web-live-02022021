<?php
	Class General_admin
	{
        ...
        $sql = "SELECT SUM(fTripGenerateFare) as totalTripAmount,SUM(fCommision) as totalCommissionAmount FROM trips WHERE eDriverPaymentStatus = 'Unsettelled' AND vTripPaymentMode='Card' AND iDriverId = '".$id."'".$ssql;
				$data = $obj->MySQLSelect($sql);
        //$total = ($data[0]['totalAmount'] != "")?$data[0]['totalAmount']:'0.00';
