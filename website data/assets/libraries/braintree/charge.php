<?php                     
  ...
  try
  {
    ...
    $result->success;
    # true
    $creditCardArr = $result->transaction->creditCard;
echo "Token >> ".    $token = $creditCardArr['token'];echo "<br />"; 
    //echo "<pre>";print_r($creditCardArr);exit;
    ...
    echo "Transaction ID  >> ".$result->transaction->id;echo "<br />";
