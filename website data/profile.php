    ...
    ?>
                        ...
                        <?
                            ...
                            if ($UploadDocuments == 'No') {
                                ...
                                <div class="demo-warning">
                                    <p>
            <?php if (isset($_REQUEST['first']) && $_REQUEST['first'] == 'yes') {
                echo $langage_lbl['LBL_PROFILE_WE_SEE_YOU_HAVE_REGISTERED_AS_A_DRIVER'];
            }
            ?>
                                    </p>
                                    <p>
            <?php if ($db_user[0]['eStatus'] == 'inactive') {
...
<?php } ?>
                        ...
                        if ($db_user[0]['vImage'] == 'NONE' || $db_user[0]['vImage'] == '') {
                            ...
                            <div class="driver-profile-info">
                                <h3><? if ($_SESSION['sess_user'] == 'driver') {
...
<? } ?>
                                    ...
                                    <?php } ?>
                                    <span>
                                        <label>Zip  <?php if ($_SESSION['sess_user'] == 'company') { ?><span class="red">*</span><? } ?></label>
        ...
        <script type="text/javascript">
            ...
            $('#frm1').validate({
                ...
                messages: {
                    ...
                    phone: {minlength: 'Please enter at least three Number.', digits: 'Please enter proper mobile number.', remote: function () {
                            return errormessage;
                        }}
                },
