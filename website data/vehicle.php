...
if ($action == 'delete') {
    ...
    if (!$valid_user) {
        ...
        $getDriverData = $obj->MySQLSelect("SELECT iDriverVehicleId FROM register_driver WHERE iDriverId='" . $driverid . "'");//added by SP when vehicle is active then it can not be deleted on 28-09-2019
...
<html lang="en" dir="<?= (isset($_SESSION['eDirectionCode']) && $_SESSION['eDirectionCode'] != "") ? $_SESSION['eDirectionCode'] : 'ltr'; ?>">
    ...
    <body>
                                                                        ...
                                                                        <?php if ($db_userdoc[$s]['ex_status'] == 'yes') { ?>
                                                                            <div class="col-lg-13 exp-date">
                                                                                <div class="input-group input-append date dp123">
                                                                                    <input class="form-control readonlyNew" type="text" name="dLicenceExp"  value="<?php echo ($db_userdoc[$s]['ex_date'] != "") ? $db_userdoc[$s]['ex_date'] : ''; ?>"  required/>
        ...
        <script type="text/javascript" src="<?= SITE_ADMIN_URL; ?>/js/moment.min.js"></script>
        <script type="text/javascript" src="<?= SITE_ADMIN_URL; ?>/js/bootstrap-datetimepicker.min.js"></script>
