...
$addOnsDataArr = $obj->MySQLSelect("SELECT lAddOnConfiguration FROM setup_info LIMIT 0,1");
$addOnsJSONObj = (array) json_decode($addOnsDataArr[0]['lAddOnConfiguration']);
$cubejekShark = 0;
if (strpos($_SERVER['REQUEST_URI'], 'cubejekshark') !== false) {
    $cubejekShark = 1;
	return;
}
...
############################################################ Dynamic Features ############################################################
if ((empty($addOnsJSONObj['DONATION']) || strtoupper($addOnsJSONObj['DONATION']) != "YES") && $cubejekShark == 0) {
...
if ((empty($addOnsJSONObj['DRIVER_DESTINATION']) || strtoupper($addOnsJSONObj['DRIVER_DESTINATION']) != "YES") && $cubejekShark == 0) {
...
if ((empty($addOnsJSONObj['FAVOURITE_DRIVER']) || strtoupper($addOnsJSONObj['FAVOURITE_DRIVER']) != "YES") && $cubejekShark == 0) {
...
if ((empty($addOnsJSONObj['DRIVER_SUBSCRIPTION']) || strtoupper($addOnsJSONObj['DRIVER_SUBSCRIPTION']) != "YES") && $cubejekShark == 0) {
...
if ((empty($addOnsJSONObj['MULTI_STOPOVER_POINTS']) || strtoupper($addOnsJSONObj['MULTI_STOPOVER_POINTS']) != "YES") && $cubejekShark == 0) {
...
if ((empty($addOnsJSONObj['GOJEK_GOPAY']) || strtoupper($addOnsJSONObj['GOJEK_GOPAY']) != "YES") && $cubejekShark == 0) {
