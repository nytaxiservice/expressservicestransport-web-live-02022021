    ...
    <body>
                    ...
                    <div class="driver-add-vehicle"> 
                        <? if ($success == 1) { ?>
                            <div class="alert alert-success alert-dismissable">
                                ...
                                <?= $langage_lbl['LBL_SERVICE_UPDATE_SUCCESS']; ?>
                            </div>
                        <? } else if ($success == 2) { ?>
        ...
        <script>
                var driverReqModule = '<?php echo $ENABLE_DRIVER_SERVICE_REQUEST_MODULE; ?>';	
                                        ...
                                        {
                                            var checkedState = $('#vCarType1_' + val1).attr('checked');
                                            if ($('#vCarType1_' + val1).is(':checked'))
                                            {
                                                $("#amt1_" + val1).show();
                                                $("#fAmount_" + val1).focus();
                                            } else {
                                                if(driverReqModule == 'Yes' && checkedState == 'checked')
                                        ...
                                        function cTrig(clickedid) { 
                                                var checkedState = $('#' + clickedid).attr('checked');
