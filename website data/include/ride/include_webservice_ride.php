...
function TripCollectTip($iMemberId, $iTripId, $fAmount) {
    ...
    $vFlutterWaveToken = get_value($tbl_name, 'vFlutterWaveToken', $iUserId, $iMemberId, '', 'true');
...
function getHotelDetailInfo($passengerID, $cityName) {
    global $generalobj, $obj, $demo_site_msg, $PHOTO_UPLOAD_SERVICE_ENABLE, $parent_ufx_catid, $generalConfigArr, $tconfig, $vTimeZone, $vUserDeviceCountry, $_REQUEST, $intervalmins, $generalConfigPaymentArr, $ENABLE_RESTAURANTS_ADVERTISEMENT_BANNER, $ADVERTISEMENT_TYPE;
